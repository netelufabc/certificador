...
class Curso_model extends CI_Model {
    ...
    public function update_curso($dados_curso, $id_curso) { //função para update na tabela cursos (GUC)
        $this->db->where('id_curso', $id_curso);
        $this->db->update('cert_cursos', $dados_curso);
        $this->session->set_flashdata('alterar_curso_ok', 'Dados do curso alterados com sucesso!');
        redirect('Admin');
    }

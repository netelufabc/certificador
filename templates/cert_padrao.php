...
$into = utf8_decode("O Núcleo de Tecnologias Educacionais da Universidade Federal do ABC \n confere o presente certificado a");
...
$texto = utf8_decode($exibe_doc ."pela conclusão do curso " . strtoupper($curso['nomeCurso']) . ", em que obteve o conceito final \"" . $alunocurso['conceito'] . "\"."

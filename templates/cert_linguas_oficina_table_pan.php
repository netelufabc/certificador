...
$texto = utf8_decode(exibe_doc($aluno['tipo_doc'], $aluno['num_doc']) . "pela participação na " . $curso['nomeCurso'] . ". "
        . "Devido à pandemia de Covid-19, declarada em março de 2020, esta oficina presencial "
        . "foi adaptada, de forma que o período e o percentual de atividades remotas e "
        . "presenciais se encontram no verso deste certificado.");
...
if (strtotime($data_criado) < strtotime("2021-03-01") || strtotime($data_criado) > strtotime("2021-03-22")) {//alteração tenporária; FAMT
    $assinatura = 'images/assinaturas/ass_trans_janaina.png';
    $coordenador = utf8_decode("Janaína Gonçalves");
    $fpdf->Image($assinatura, 204, 149, 45);
...
//cargo
    ...
    $assinatura = 'images/assinaturas/ass_trans_elias.png';
    $coordenador = utf8_decode("Elias David Morales Martinez");
    $fpdf->Image($assinatura, 198, 155, 45);
...
//cargo
    ...
    $fpdf->MultiCell(0, 7, utf8_decode("Substituto eventual da Chefe da Divisão de Idioma"), $bordas, 'C');
}

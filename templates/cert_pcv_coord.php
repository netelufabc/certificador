...
$texto = utf8_decode("Certificamos que " . mb_strtoupper($aluno['nome'].', ') . exibe_doc($aluno['tipo_doc'], $aluno['num_doc']) . " coordenou o planejamento, a oferta e a avaliação do "
        . "módulo \"" . mb_strtoupper($curso['nomeCurso']) . "\" do curso \"DOCÊNCIA COM TECNOLOGIAS\" "
        . "na modalidade remota. O curso foi ministrado no período de $dataIni a $dataFim. "
        . "No desempenho de suas atividades, dedicou um total de $curso[cargaHoraria] horas.");

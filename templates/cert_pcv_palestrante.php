...
$texto = utf8_decode("Certificamos que " . mb_strtoupper($aluno['nome']) . " ministrou o " . mb_strtoupper($curso['nomeCurso']) . " realizado no formato online como parte integrante do curso "

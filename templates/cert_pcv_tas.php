...
$texto = utf8_decode("Certificamos que " . mb_strtoupper($aluno['nome'].', ') . exibe_doc($aluno['tipo_doc'], $aluno['num_doc']) . " apoiou a preparação e oferta do "
        . "módulo \"" . mb_strtoupper($curso['nomeCurso']) . "\" do curso \"DOCÊNCIA COM TECNOLOGIAS\" "
        . "como servidor na equipe do NETEL. "

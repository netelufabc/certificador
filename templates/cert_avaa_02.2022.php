...
$texto = utf8_decode(exibe_doc($aluno['tipo_doc'], $aluno['num_doc'])."pela conclusão do curso \"". mb_strtoupper($curso['nomeCurso']) ."\", "
        . "realizado em formato MOOC (sem tutoria), em 2021, com carga horária de $curso[cargaHoraria] horas "
        . "distribuídas ao longo de 6 semanas.");
$fpdf->SetX(35);
$fpdf->SetFont('arial', '', 18);
...
$fpdf->SetX(50);
$fpdf->MultiCell(80, 5, 'Coordenadora Geral - NETEL', $bordas, 'C');

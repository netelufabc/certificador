...
$texto = utf8_decode("Certificamos que " . mb_strtoupper($aluno['nome']) . " apresentou trabalho no " . mb_strtoupper($curso['nomeCurso']) . " realizado no formato online como parte integrante do curso "
        . "\"Planejamento de cursos virtuais: como organizar a sua disciplina\" oferecido pelo Núcleo Educacional de Tecnologias e Línguas "
        . "da Universidade Federal do ABC no dia $dataIni.");

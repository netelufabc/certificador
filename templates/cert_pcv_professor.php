...
$texto = utf8_decode("Certificamos que " . mb_strtoupper($aluno['nome'].', ') . exibe_doc($aluno['tipo_doc'], $aluno['num_doc']) . " apoiou a oferta do "
        . "módulo \"" . mb_strtoupper($curso['nomeCurso']) . "\" do curso \"DOCÊNCIA COM TECNOLOGIAS\" "
        . "como docente selecionado no edital NETEL 20/2020. O curso foi ministrado "
        . "no período de $dataIni a $dataFim. No desempenho de suas atividades, dedicou um total de $curso[cargaHoraria] horas.");

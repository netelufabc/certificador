...
$texto = utf8_decode("Certificamos que " . mb_strtoupper($aluno['nome'].', ') . exibe_doc($aluno['tipo_doc'], $aluno['num_doc']) . " foi aprovado(a) no "
        ...
        . "com carga horária de $curso[cargaHoraria] horas.");

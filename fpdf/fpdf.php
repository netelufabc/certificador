...
if (!defined('constant')) define('FPDF_VERSION','1.81');
...
protected function _dochecks()
{
	...
	//if(get_magic_quotes_runtime())//esta função get_magic_quotes_runtime foi deprecated no php 7.4 em diante, estas linhas foram comentadas para permitir rodar em versões php mais novas
